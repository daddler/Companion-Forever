...
def test_a_defensive_cooldown_is_recognised_in_both_languages(demo_abilities):
    """
    ...
    assert cd.category_of("", 9003) == CD_DEFENSIVE


def test_raid_and_heal_cooldowns_keep_their_drawer(demo_abilities):
...
def test_the_source_wins_when_it_says_something(demo_abilities):
