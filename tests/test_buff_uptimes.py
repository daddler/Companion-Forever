...
def test_the_check_resolves_the_ability_in_both_languages(demo_abilities):
...
def test_the_bot_payload_carries_the_block(demo_abilities):
    """
    ...
    payload = {
        "status": "ok",
        "fight": {"name": "Übungsziel", "duration": 180.0, "in_progress": False},
        "players": [
            {
                "name": "Bramborn",
                "class": "Warrior",
