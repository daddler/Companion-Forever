...
def test_a_german_report_is_recognised_and_gets_its_target_value(demo_abilities):
...
def test_an_english_report_is_shown_in_german(demo_abilities):
    """
...
def test_the_spell_id_wins_over_a_name_nobody_knows(demo_abilities):
    """
...
def test_a_hot_filed_under_dots_lands_in_the_hot_list(demo_abilities):
    """
...
def test_missing_abilities_are_filled_with_zero_when_the_source_delivers(demo_abilities):
...
def test_talent_dependent_abilities_are_never_filled_in(demo_abilities):
    """
...
def test_unused_cooldowns_of_the_spec_appear_with_their_cooldown(demo_abilities):
...
def test_situational_cooldowns_carry_no_upper_bound(demo_abilities):
    """
...
def test_the_live_cooldown_lists_use_the_same_names(demo_abilities):
...
def test_the_hint_names_what_the_spec_would_show(demo_abilities):
