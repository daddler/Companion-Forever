...
#
# "Rolle nicht bestimmbar" - und zwar nicht, weil eine Angabe fehlt,
# sondern weil die Quelle sie nicht enthält. In Forever tragen
# dieselben Talente die Katze und den Bären; welche von beiden jemand
# gerade ist, steht im Kampf und nicht im Talentbaum
# (analyzer/data/specs.py).
#
# Bewusst ein eigener Wert und nicht der leere String: der leere
# String bedeutet an den Rändern dieser Anwendung "nichts gemeldet",
# und die beiden auseinanderzuhalten ist der Unterschied zwischen
# "frag die Quelle noch einmal" und "diese Frage beantwortet die
# Quelle nicht". Dieselbe Linie wie `stars == 0` und `at == -1`.
#
