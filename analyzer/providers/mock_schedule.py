...
EVENT_SCHEDULE: tuple[
    ...
    (36.0, "cast", "Horridon", "", "Doppelschlag",
...
DAMAGE_TAKEN: tuple[tuple[str, str, tuple[float, ...], float], ...] = (
    ...
    ("Nachtblatt", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Pyrothal", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Grimmzahn", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Silbermond", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Falkenauge", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Verdammnis", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Schattenruf", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Sturmklinge", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Lichthammer", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Seuchenherz", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Windschritt", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Krallenwut", "Ruf der Nacht", (37.0,), 54000.0),
    ("Arkanis", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Dolchtanz", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Feuerbrand", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Frostgrimm", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Bestienrufer", "Ruf der Nacht", (37.0, 88.0), 54000.0),
    ("Donnerfaust", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Elvenne", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Torvald", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Miraia", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Kaldrun", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ("Yunwei", "Ruf der Nacht", (37.0, 88.0, 139.0), 54000.0),
    ...
    ("Dolchtanz", "Doppelschlag", (34.0, 112.0), 96000.0),
    ("Windschritt", "Zerfetzender Ansturm", (108.0, 121.0, 149.0), 78000.0),
    ("Krallenwut", "Inferno", (158.0,), 132000.0),
    ("Frostgrimm", "Schwarmbefall", (71.0,), 64000.0),
    ("Bestienrufer", "Giftsalve", (95.0, 118.0), 71000.0),
    ("Feuerbrand", "Zerfetzender Ansturm", (143.0,), 88000.0),
    ("Schattenruf", "Giftsalve", (66.0,), 71000.0),
...
ROSTER: tuple[tuple[str, str, str, str, float], ...] = (
    ...
    ("Sigmara", "Paladin", "Schutz", ROLE_TANK, 38500.0),
    ...
    ("Yunwei", "Priest", "Heilig", ROLE_HEALER, 63500.0),
    ...
    ("Seuchenherz", "Warlock", "Dämonologie", ROLE_DPS, 123500.0),
    ("Windschritt", "Rogue", "Täuschung", ROLE_DPS, 116000.0),
    ...
    ("Frostgrimm", "Mage", "Frost", ROLE_DPS, 110500.0),
...
# ein Elementarschamane, ein Täuschungsschurke, ein Arkanmagier hatten
