...
# haben.
#
# Forever endet bei 60, "hohe Stufe" heißt hier deshalb
# Höchststufe. `characters_min_level` in der Konfiguration setzt den
# Wert herunter, wer seine 58er mitzählen will - dieselbe Überlegung
...
# Konstanten bleiben als Rückfall für Aufrufer ohne Spielversion.
#
