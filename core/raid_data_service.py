...
# --------------------------------------------------
#
# MODE_LIVE/MODE_ARCHIVE/MODE_REPLAY und die Datenklassen
# `ArchiveState`/`ReplayState` selbst stehen in `core/raid_state.py` -
# Qt-frei, damit Stellen wie `core/raid_context.py` und
# `tests/test_raid_context.py`, die diese Werte nur lesen, nicht über
# sie PySide6 mitgeladen bekommen. Der Import oben reicht sie nur
# weiter, damit `from core.raid_data_service import MODE_LIVE,
# ArchiveState, …` weiterhin gilt.
#
